        ...
        <div className='card max-w-lg w-full p-6 animate-slide-up'>
            ...
            <form onSubmit={handleSubmit} className='space-y-4'>
                ...
                <div>
                    ...
                    <select name='employeeId' required className='form-select'>
                ...
                {/* select month and year */}
                  <div className='grid grid-cols-2 gap-4'>
                      ...
                      <div>
                          ...
                          <input type='number' name='year' defaultValue={new Date().getFullYear()} className='form-input' />
                      </div>
                  </div>
                  {/* basic salary */}
                  ...
                  <div>
                      ...
                      <input type='number' name='basicSalary' required placeholder="5000" className='form-input' />
                  </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input type='number' name='allowances' defaultValue="0" className='form-input' />
                  </div>
                  <div>
                      <label className='block text-sm font-medium text-slate-700 mb-2'>Deductions</label>
                      <input type='number' name='deductions' defaultValue="0" className='form-input' />
                  </div>
                </div>
                {/* buttons */}
                <div className='flex justify-end gap-3 pt-2'>
                    <button onClick={()=>setIsOpen(false)} type='button' className='btn-primary'>Cancel</button>
