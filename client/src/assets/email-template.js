// Email templates as functions that accept data
export const attendanceCheckoutTemplate = (employee = {}, attendance = {}) => `
    <div style="max-width: 600px;">
        <h2>Hi ${employee.firstName || ""}, 👋</h2>
        <p style="font-size: 16px;">You have a check-in in ${employee.department || ""} today:</p>
        <p style="font-size: 18px; font-weight: bold; color: #007bff; margin: 8px 0;">${attendance?.checkIn ? new Date(attendance.checkIn).toLocaleTimeString() : ""}</p>
...
export const leaveApplicationTemplate = (leaveApplication = {}, employee = {}) => `
    <div style="max-width: 600px;">
        <h2>Hi Admin, 👋</h2>
        <p style="font-size: 16px;">You have a leave application in ${employee.department || ""} today:</p>
        <p style="font-size: 18px; font-weight: bold; color: #007bff; margin: 8px 0;">${leaveApplication?.startDate ? new Date(leaveApplication.startDate).toLocaleDateString() : ""}</p>
...
export const attendanceReminderTemplate = (emp = {}) => `
