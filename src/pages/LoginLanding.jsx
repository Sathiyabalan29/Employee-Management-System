        ...
        <div className='w-full max-w-md animate-fade-in relative z-10'>
          ...
          <div className='space-y-4'>
              ...
              return (
                ...
                >
                  <div className='relative z-10 flex items-start justify-between gap-4 sm:gap-5'>
                    ...
                    <ArrowRightIcon className='w-4 h-4 shrink-0 text-slate-400 group-hover:text-indigo-600 group-hover:translate-x-1 transition-all duration-300 mt-1' />
                  </div>
                </Link>
              )
            })}
            ...
            <div className='mt-12 text-center md:text-left text-sm text-slate-400'>
              <p>© {new Date().getFullYear()} Sathiyabalan. All 
                rights reserved.</p>
